...
export default function ImportInvoice() {
  ...
  const loadCustomers = async () => {
    try {
      const response = await apiClient.getCustomers({ type: 'IMPORT', limit: 0 });
      if (response.data) {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 px-3 py-2 md:px-6 md:py-3 flex flex-col md:flex-row items-start md:items-center justify-between gap-2">
        <Breadcrumb
          items={[
            ...
            { label: 'فواتير الاستيراد' }
          ]}
        />
        {canCreate('invoices.type2') && (
          <button
            onClick={() => {
              setEditingInvoice(null);
              reset({
            ...
            className="flex items-center gap-1.5 md:gap-2 px-3 py-1.5 md:px-6 md:py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm md:text-base w-full md:w-auto justify-center"
          >
            ...
            <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 flex-shrink-0">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">
                  {editingInvoice ? 'تعديل بيانات فاتورة استيراد' : 'إنشاء فاتورة استيراد جديدة'}
                </h2>
                <button
            ...
            <div className="overflow-y-auto flex-1 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent [scrollbar-gutter:stable] hover:scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-600">
              <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-200 dark:border-green-700 rounded-xl p-4 shadow-sm">
                    <div className="flex items-center justify-between">
